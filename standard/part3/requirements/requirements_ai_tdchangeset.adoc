...
The AI_TDChangeset object is encoded as an XML element with properties shown in <<table-ai-tdchangeset-properties>>.

[width="100%",cols="20%,80%",options="unnumbered"]
|===
|Requirement 32
a|/req/aitdchangeset/tdchangeset

Each AI_TDChangeset object SHALL implement the Mandatory properties as shown in <<table-ai-tdchangeset-properties>>.
|===

[[table-ai-tdchangeset-properties]]
.AI_TDChangeset properties
