...
The AI_TrainingDataset object is encoded as an XML element with properties shown in <<table-ai-trainingdataset-properties>>.
...
If the optional element AI_MetricsInLiterature is specified, this element is encoded as XML element with properties as shown in <<table-ai-metricsinliterature-properties>>.
...
The AI_EOTrainingDataset object is encoded as an XML element with properties shown in <<table-ai-trainingdataset-properties>> and <<table-ai-eotrainingdataset-properties>>.
