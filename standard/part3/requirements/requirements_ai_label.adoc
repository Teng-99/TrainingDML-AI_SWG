...
The AI_Label object is encoded as an XML element with properties as shown in <<table-ai-label-properties>>.
...
The AI_SceneLabel object is encoded as an XML element with properties as shown in <<table-ai-scenelabel-properties>>.
...
Each AI_SceneLabel object SHALL implement the Mandatory properties shown in <<table-ai-scenelabel-properties>>.
|===
...
The AI_ObjectLabel object is encoded as an XML element with properties shown in <<table-ai-objectlabel-properties>>.
...
The AI_PixelLabel object is encoded as an XML element with properties as shown in <<table-ai-pixellabel-properties>>.
