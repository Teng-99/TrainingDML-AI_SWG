...
The QualityElement object is encoded as an XML element with properties shown in <<table-qualityelement-properties>>.

[width="100%",cols="20%,80%",options="unnumbered"]
|===
|Requirement 12
a|/req/base/isoqualitytype/element

Each QualityElement value SHALL be encoded as an XML element with properties shown in <<table-qualityelement-properties>>.
|===

[[table-qualityelement-properties]]
