...
The JSON format is currently described by two competing standards, RFC7159 and <<ISOIEC21778>>. Both standards documents are consistent, but the latter defines mainly the grammatical syntax where the former provides some additional semantic and security points.
