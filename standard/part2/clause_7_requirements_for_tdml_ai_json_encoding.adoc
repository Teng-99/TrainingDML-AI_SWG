...
The AI_DataQuality requirements class defines a JSON encoding for the AI_DataQuality module, which is based on the UML model specified in the TrainingDML-AI Part 1: Conceptual Model Standard.
