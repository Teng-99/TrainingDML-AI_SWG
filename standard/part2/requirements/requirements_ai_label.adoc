...
The AI_Label object is encoded as a JSON object with properties as shown in <<table-ai-label-properties>>.
...
Each AI_Label object SHALL implement the Mandatory properties shown in <<table-ai-label-properties>>.
|===

[[table-ai-label-properties]]
.AI_Label properties
[width="100%",cols="25%,25%,25%,25%",options="header",]
|===
|JSON Property |Definition |Data type and values |Obligation
|type |Type of the label object. |"AI_AbstractLabel" |Mandatory
|isNegative |Whether the training sample related to the label is a positive or negative sample. a|Bool [0..1] 

Default: false |Optional
|confidence |Confidence score of the labeler.  a|Float [0..1] 
...
The AI_SceneLabel object is encoded as a JSON object with properties as shown in <<table-ai-scenelabel-properties>>.

[width="100%",cols="20%,80%",options="unnumbered"]
|===
|Requirement 23
a|/req/ailabel/scenelabel

Each AI_SceneLabel object SHALL implement the properties shown in <<table-ai-scenelabel-properties>>.
|===

[[table-ai-scenelabel-properties]]
...
The AI_ObjectLabel object is encoded as a JSON object with properties shown in <<table-ai-objectlabel-properties>>.

[width="100%",cols="20%,80%",options="unnumbered"]
|===
|Requirement 24
a|/req/ailabel/objectlabel

Each AI_ObjectLabel object SHALL implement the Mandatory properties shown in <<table-ai-objectlabel-properties>>.
|===

[[table-ai-objectlabel-properties]]
...
The AI_PixelLabel object is encoded as a JSON object with properties as shown in <<table-ai-pixellabel-properties>>.

[width="100%",cols="20%,80%",options="unnumbered"]
|===
|Requirement 25
a|/req/ailabel/pixellabel

Each AI_PixelLabel object shall implement the Mandatory properties shown in <<table-ai-pixellabel-properties>>.
|===

[[table-ai-pixellabel-properties]]
.AI_PixelLabel properties
[width="100%",cols="25%,25%,25%,25%",options="header",]
|===
|JSON Property |Definition |Data type and values |Obligation
|type |Type of the label object at the pixel level. |"AI_PixelLabel" |Mandatory
|imageURL |URL of the images representing the label information. |URI [1..*] |Mandatory
...
----
{
  "type": "AI_PixelLabel",
  "imageURL": [
    "/label_5classes/GF2_PMS1__L1A0000647767-MSS1_label.tif"
  ],
  "imageFormat": [
