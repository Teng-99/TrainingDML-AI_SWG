...
The QualityElement object is encoded as a JSON object with properties shown in <<table-qualityelement-properties>>.
...
Each QualityElement value SHALL be encoded as a JSON object with properties shown in <<table-qualityelement-properties>>.
|===
