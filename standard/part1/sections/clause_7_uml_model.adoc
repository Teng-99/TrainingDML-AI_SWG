...
The Code Lists provided for the AI_Label are illustrated in <<figure-uml-label-codelist>>.

.Code lists from the AI_Label.
[[figure-uml-label-codelist]]
image::figures/uml_model_label_codelist.jpg[]
...
.Code list classes defined in AI_Label
[width="100%",cols="34%,66%",options="header",]
|===
|Name |Description
|AI_ImageFormatCode +
«CodeList»
|AI_ImageFormatCode is a code list used to specify the MIME type of an image.
|===
...
The Code Lists provided for the AI_Labeling are illustrated in <<figure-uml-labeling-codelist>>.

.Code lists from the AI_Labeling.
[[figure-uml-labeling-codelist]]
image::figures/uml_model_labeling_codelist.jpg[]
...
.Code list classes defined in AI_Labeling
[width="100%",cols="34%,66%",options="header",]
|===
|Name |Description
|AI_LabelingMethodCode +
«CodeList»
|AI_LabelingMethodCode is a code list used to identify the methods used in the labeling procedure.
|===
