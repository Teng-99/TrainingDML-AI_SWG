...
==== MD_ReferenceSystem (from ISO 19115-1:2014)

.Metadata of MD_ReferenceSystem (Class)
[width="100%",cols="34%,66%",options="",]
|===
...
==== LI_Lineage (from ISO 19115-1:2014)

.Metadata of LI_Lineage (Class)
[width="100%",cols="34%,66%",options="",]
|===
...
==== MD_Resolution (from ISO 19115-1:2014)

.Metadata of MD_Resolution (Class)
[width="100%",cols="34%,66%",options="",]
|===
...
|dataTime |DateTime [0..*] |Date and time at which the geospatial data were obtained.
...
.Metadata of AI_ImageFormatCode (CodeList)
[width="100%",cols="20%,80%",options="",]
|===
...
.Attributes of AI_Labeling (Class)
[width="100%",cols="20%,35%,45%",options="header",]
|===
|*Attribute* |*Value type and multiplicity* |*Definition*
...
.Metadata of AI_LabelingMethodCode (CodeList)
